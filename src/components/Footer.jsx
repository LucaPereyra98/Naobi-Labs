                ...
                <div className="row text-center text-md-left">
                    <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                        <a href={"/"} className="text-decoration-none">
                            ...
                            <h5 className="text-uppercase mb-2 font-weight-bold text-warning">Proyecto E-commerce</h5>
                        </a>
                        <p className="text-white">Proyecto de E-commerce creado con React JS para la carrera de Desarrollador Fullstack de Coderhouse</p>
                    </div>
